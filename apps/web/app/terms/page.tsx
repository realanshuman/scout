    ...
    <LegalPage title="Terms" updated="July 2026">
      ...
      <div>
        ...
        <p className="mt-2">
          ...
          investors with suggested outreach. It&apos;s a research and drafting tool, and
          the matches and emails are recommendations for you to review, not guarantees of
      ...
      <div>
        ...
        <p className="mt-2">
          ...
          can reach out thoughtfully, and treat them with the same care you&apos;d want.
        </p>
      </div>
    </LegalPage>
  );
